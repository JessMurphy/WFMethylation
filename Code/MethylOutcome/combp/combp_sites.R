...
setwd("/nfs/storage/math/gross-s2/projects/guatemala/Guatemala-omics/Methylation/EWAS/combp/EWAS/results/")

# read in the top comb-p region results
arm = read.table("combp_arm_results.regions-p.bed")
bmi = read.table("combp_bmi_results.regions-p.bed")
int = read.table("combp_interaction_results.regions-p.bed")

# read in the comb-p fdr site results
arm2 = read.table("combp_arm_results.fdr.bed")
bmi2 = read.table("combp_bmi_results.fdr.bed")
int2 = read.table("combp_interaction_results.fdr.bed")
...
results = read.table("EWAS_results_FDR.txt", header=T, sep='\t')
...
# call function
region_sites(arm, arm2, "combp_arm_sites")
region_sites(bmi, bmi2, "combp_bmi_sites")
region_sites(int, int2, "combp_int_sites")
