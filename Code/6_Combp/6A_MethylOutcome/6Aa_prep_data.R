...
write.table(re_int, 'ToSort_interaction4combp.bed', 
            sep = '\t', quote = FALSE, row.names = FALSE)
write.table(re_arm, 'ToSort_arm4combp.bed', 
            sep = '\t', quote = FALSE, row.names = FALSE)
write.table(re_BMI, 'ToSort_bmi4combp.bed', 
            sep = '\t', quote = FALSE, row.names = FALSE)
...
write.table(df, 'Sorted_arm4combp.bed', row.names = FALSE, quote = FALSE,
            sep = '\t')


### interaction

df <- fread('Sorted_interaction4combp.bed')
colnames(df) <- c('chrom', 'start', 'end', 'rawp')
summary(df$rawp)
...
write.table(df, 'Sorted_interaction4combp.bed', row.names = FALSE, quote = FALSE,
            sep = '\t')


#### bmi

df <- fread('Sorted_bmi4combp.bed')
colnames(df) <- c('chrom', 'start', 'end', 'rawp')
summary(df$rawp)
...
write.table(df, 'Sorted_bmi4combp.bed', row.names = FALSE, quote = FALSE,
            sep = '\t')
