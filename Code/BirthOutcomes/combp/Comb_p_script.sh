...
cd /nfs/storage/math/gross-s2/projects/guatemala/Guatemala-omics/Methylation/BirthOutcomes/combp/FilePrep
nano ToSort_in...   
...
for phen in WLGAZ WGAZ LGAZ HCGAZ
do

bedtools2/bin/bedtools sort -i /nfs/storage/math/gross-s2/projects/guatemala/Guatemala-omics/Methylation/BirthOutcomes/combp/FilePrep/ToSort_$phen\4combp.bed > /nfs/storage/math/gross-s2/projects/guatemala/Guatemala-omics/Methylation/BirthOutcomes/combp/FilePrep/Sorted_$phen\4combp.bed 
...
cd /nfs/storage/math/gross-s2/projects/guatemala/Guatemala-omics/Methylation/BirthOutcomes/combp/

for phen in WLGAZ WGAZ LGAZ HCGAZ
do

comb-p pipeline -c 4 --seed 0.05 --dist 300 -p results/combp_$phen\_results --region-filter-p 0.05 --anno hg19 FilePrep/Sorted_$phen\4combp.bed
